...
export function ArticleCard({ article }: ArticleCard) {
    ...
    return (
        <Link href={link}>
        <div className="w-[87vw] h-[210px] p-[30px] bg-white rounded-lg shadow-lg flex flex-row justify-between gap-6
                        md:w-[40vw]">
            <div className="overflow-ellipsis">
                <h2 className="font-ebgaramond font-bold text-xl line-clamp-2 leading-6">{title}</h2>
