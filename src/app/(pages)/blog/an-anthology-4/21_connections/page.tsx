		...
		<div>
			<div className={styles.main}>
				<div className={styles.container}>
					...
					In this digital age, we are connected but simultaneously so disconnected. We&apos;re glued to the screens, weary eyed, and filled with feelings of cynicism and pessimism as we&apos;re flooded daily with more information than humans were designed to handle. Gen Z and Gen Alpha are arguably some of the most digitally-immersed and globally informed generations of all of history. Yet despite all this connection, we are known as the <q>loneliest generation.</q> It&apos;s quite ironic. We search for fulfillment and the approval of strangers online more than we seek the opinion of the One who created and knows us deeper than anyone else.<br/><br/>
					...
					<i>And all who believed were together and had <b>all</b> things in common.</i><br/>
