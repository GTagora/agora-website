				...
				<div className={styles.container}>
					...
					<div className={styles.text}>
						...
						<p>
							...
							be satisfied with only knowing acquaintances.
						</p>
						<br />
						...
						<p>
							...
							opposed to “many companions”
							<Reference number={2} /> [Proverbs 12:26, 18:24]. Friendship also
							means being closely involved in one another’s lives. Jesus called
							his disciples “friends” and was deeply involved in their lives:
						...
						<p>
							...
							called to worship God together, love and serve one another, and be
							a light to those outside the church. We are no longer “strangers”
							to God or to one another, but we are chosen into an eternal
							family, united under Christ.
						</p>
						<br />
						...
						<p>
							...
							friend groups are exclusive. According to Aristotle, “A friend to
							all is a friend to none”, and there is some truth to that. There
							is a depth and commitment to real friendship that cannot be
							realistically maintained with too many people.
						</p>
						<br />
						...
						<p>
							...
							can’t be friends with everyone. Sometimes, we can’t even be good
							friends to the ones we have; we fail to love one another time and
							time again. Which is why we are told to not put our trust “in
							human beings, who cannot save”
							<Reference number={15} /> [Psalm 146:3].
						</p>
						<Reference number={16} />
						<p>
							But there is one who can save, who calls us both friends
							<Reference number={16} /> [John 15:13-15] and family
							<Reference number={17} /> [Matthew 12:50]. The extent of His love
							doesn’t dilute its depth or intensity. His friendship extends to
							us all individually and personally; dying for us while we were
							still sinners and walking with us as we are sanctified. Jesus
							himself called us friends when he said “greater love has no one
							than this, that someone lay down his life for his friends”
							<sup>16</sup> [John 15:13-15] and that is exactly what He did for
							us on that cross. As impossible as it may seem, His command for us
							is to love one another with that same self-sacrificial love. And
							that is what it means to “abide in the vine.” It is only through
							our relationship with Christ that we can truly know His love for
							us and be able to love each other the same way. He is a friend who
							has chosen us, walks with us daily, and intercedes on our behalf.
